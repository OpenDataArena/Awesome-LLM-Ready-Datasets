...
- **数据集目录**
  - [文本](#文本-text)
    - [预训练](#text-pretraining)
    - [指令微调](#text-instruction-tuning)
    - [对齐/强化学习](#text-alignment-rlhf)
    - [评测/基准](#text-evaluation-benchmark)
    - [检索](#text-retrieval-rag)
  - [代码](#代码-code)
    - [预训练](#code-pretraining)
    - [指令微调](#code-instruction-tuning)
    - [对齐/强化学习](#code-alignment-rlhf)
    - [评测/基准](#code-evaluation-benchmark)
    - [检索](#code-retrieval-rag)
  - [多模态](#多模态-multimodal)
    - [预训练](#multimodal-pretraining)
    - [指令微调](#multimodal-instruction-tuning)
    - [对齐/强化学习](#multimodal-alignment-rlhf)
    - [评测/基准](#multimodal-evaluation-benchmark)
    - [检索](#multimodal-retrieval-rag)
  - [生成（图像/视频/音频）](#生成-gen)
    - [预训练](#gen-pretraining)
    - [指令微调](#gen-instruction-tuning)
    - [对齐/强化学习](#gen-alignment-rlhf)
    - [评测/基准](#gen-evaluation-benchmark)
    - [检索](#gen-retrieval-rag)
  - [代理](#代理-agent)
    - [预训练](#agent-pretraining)
    - [指令微调](#agent-instruction-tuning)
    - [对齐/强化学习](#agent-alignment-rlhf)
    - [评测/基准](#agent-evaluation-benchmark)
    - [检索](#agent-retrieval-rag)
- [贡献指南](#贡献指南)
- 当前版本：v0.1
